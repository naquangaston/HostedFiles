...
`));
        ...
        async function RealBooster(_=140){
            ...
            var stats={7:-.04}
            var count=7,time=(0.6+(count*stats[7]))
            var c=center,a=player._mouse,b=rotatePoint(a,c,140)
            Fire(true)
            console.log(a,b,c)
            input.mouse(a.x,a.y)
            setTimeout(()=>{
            ...
            var center={x:innerWidth/2,y:innerHeight/2}
            var stats={7:-.04},count=_upgrade&&(_upgrade.match(/7/gi).length)||0,time=(0.6+(count*stats[7])),c=center,a=player._mouse,b=rotatePoint(a,c,140)
            Fire(true)
            input.mouse(a.x,a.y)
            await sleep(time+70)
            input.mouse(b.x,b.y)
        ...
        function MenuFix(_myWin_=globalRoot._myWin) {
            ...
            function addToggle(name, f, {defaut, desc, line, space, befors, afters }) {
                ...
                label.for=name;
                var button = document.createElement('input');button.name=name; button.onclick = f;
                var span = element('span'); span.innerText = desc || "No description."; span.className = 'menuDesc'
                if (line) myMenu.append(document.createElement('br'));
                myMenu.append(label)
                myMenu.append(button)
            ...
            addToggle('Fighter Mode', stack, {defaut:true,line:true, desc: 'autoAim rear bullets ()' })
            var allChecks = [];
        ...
        onmousedown=function (e) {
            ...
            isRightMB&&fighterMode&&(RealBooster())
        }
