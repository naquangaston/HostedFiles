...
document.getElementById("allianceHolder").style = "height: 1500px; width: 450px;"

var autoZoom = 0;
var showChat = 0;
var ns = [6, 7, 8, 9, 10, 11, 12];
var cs = [3, 4, 5, 6, 7, 8];
var ks = [.5, .55, .6, .65, .7, .75, .8, .85, .9];
var us = [.4, .43, .46, .5, .53, .55, .58, .6];
var as = [5, 6, 7, 8];
var js = ["#9ebf57", "#779438", "#86a63f"];
var ps = ["#b4db62", "#9ebf75", "#90b762"];
var Os = ["#fff", "#f7f7f7", "#e3f1f4", "#daedf1", "#c8e3ea", "#366336", "#3d5c3d"];
var Eg = ["#e0c655", "#ebdca3", "#dfc653", "#e3d082", "#d7b728", "#dac058"];
var Zg = ["#939393", "#bcbcbc", "#757575", "#989898", "#595959", "#cccccc", "#656565", "#aaaaaa"];
var Ig = ["#938d77", "#b2ab90", "#9d926c", "#a99d70", "#8f8356", "#7f7a66", "#968d69", "#a69659", "#857847"];
var Lg = ["#89a54c", "#829d48", "#97af50", "#798c40", "#afaf50", "#9d9d48", "#78a44c", "#8cb762", "#859c54", "#9c9c54", "#a5c65b", "#9bad76"];
var Sg = ["#606060", "#6f6f52", "#9d9d7b", "#a3a375", "#6b6b47", "#626250", "#8c8c73", "#989881", "#777777", "#9f9f60", "#80804d"];
var Jg = ["#c15555", "#c28c56", "#c27156", "#6a64af"];
var Ag = ["#6a64af", "#527a52", "#334d33", "#413d76", "#2b542b"];
var Sx = ["#89a54c", "#748c40", "#829d48", "#859c54", "#718547", "#8ea659", "#819060", "#899966", "#7b8a5c"];
var Xx = ["#e3f1f4", "#daedf1", "#c8e3ea", "#fff", "#e2ebf4", "#dae6f1", "#c8d9ea", "#b5cce3", "#e2f4f4", "#daf1f1", "#c8eaea", "#b5e3e3", "#a3dcdc", "#90d5d5"];
...
document.getElementById('menu').innerHTML =
    `<h3 style="font-size: 20px;" class = "indent" ⊰⊸ ok/h3>`
...
<body>
<br>
<h2 style="font-size: 17px;">⠀Miscellaneous Toggles</h2>
<label class = "indent">360 hit<input type = "checkbox" id = "hitter"><br>
<label class = "indent">Spin<input type = "checkbox" id = "spiner"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">⠀Automation Toggles</h2>
<label class = "indent">Auto Breaker<input type = "checkbox" id = "autobreaker"><br>
<label class = "indent">Auto Trap<input type = "checkbox" id = "UNION"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">⠀Bot Toggles</h2>
<label class = "indent">Bot Mode<input type = "checkbox" id = "bmm"><br>
<label class = "indent">Mele Bot Mod<input type = "checkbox" id = "xddd"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<br>
`;
document.getElementById('test').style.overflowY='scroll';

    var milllll = document.querySelector("#xddd")
    ...
    var milllllxd = document.querySelector("#bmm")
    milllllxd.addEventListener('change', function() {
        if (this.checked) {
            BM = true;
        } else {
            BM = false;
    ...
    var milllllqwe = document.querySelector("#UNION")
    milllllqwe.addEventListener('change', function() {
        if (this.checked) {
            Autotrap = true;
        } else {
            Autotrap = false;
    ...
    var millllls = document.querySelector("#autobreaker")
    millllls.addEventListener('change', function() {
        if (this.checked) {
            autobreak = true;
        } else {
            autobreak = false;
    ...
    var hit360 = document.querySelector("#hitter")
    ...
    var apinnnner = document.querySelector("#spiner")
...
function aim(x, y){
    ...
    function pwFC1() {
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(zawarudo+180));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(zawarudo+90));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(zawarudo+90));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(zawarudo+180));
...
function buttonPressD(e) { // 90% same script LMAO
    if (gay) {
            if(AB==true){
...
let dir = 0; // Spin from claude mod GGSS
setInterval(function(){//stupid xd
if(!Spinxd)return;
                doNewSend(["ch", [""]]);
aim(dir, dir - 90);
dir += 360
...
if (item == "12") {
    ...
    } // Strong Union only changed from boostType to spikeType LMAOOOO
}
     if(data[2] < 30 && ABI==0 && SD==1){
    ...
    if(item == "h" && data[1] == myPlayer.id && AB==1 && um==0 && AI==1 && tests==0){
        if(data[2] < 56 && data[2] > 0 && AB == 1) {
          autoaim = true;
         acc(21)
        hat(7)
        doNewSend(["c", [1]]);
    ...
    if (item == "h" && data[1] == myPlayer.id) {
        if (data[2] < 95 && data[2] > 94 && AI == true && myPlayer.hat == 7) {
            setTimeout(() => {
              place(foodType, null);
          hat(6);
          acc(18)
   ...
   if(data[2] < 77) {
    ...
    if(item == "h" && data[1] == myPlayer.id) {
       if(data[2] < 75 && data[2] > 0 && healToggle == 1) {//Slow heal
           setTimeout( () => {
               place(foodType, null);
               place(foodType, null);
           }, 110);
...
function acc(id) {
    ...
    doNewSend(["13c", [0, id, 1]]);
                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                 setInterval(() => { if(Proe == true) { doNewSend(["2", [90**100]]); doNewSend(["2", [90**100]]); doNewSend(["2", [90**100]]); doNewSend(["2", [90**100]]); } }, 0);
function hat(id) {
...
setInterval(()=>{
    if(Autotrap == true){//this is autotraps
...
setInterval(() => {
    if(nearestEnemy[5] == "5" && AI == true) {
        healSpeed = 22;
        instadetection = 55;
    }
    if(nearestEnemy[5] == "4" && AI == true) {
        healSpeed = 32;
        instadetection = 60;
    }
}, 0);
...
const millPlacer = repeater(78, () => {
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) + toRad(69));
    place(millType, Math.atan2(mouseY - height / 2, mouseX - width / 2) - toRad(69));
    place(millType);}, 70);
...
document.addEventListener('keydown', (e)=>{
    ...
    if(e.keyCode == 98 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        SD = (SD + 1) % 2;
        if(SD==1){
            doNewSend(["ch", ["auto:AutoSpawn: On"]]);
        }else{
            doNewSend(["ch", ["auto:AutoSpawn: Off"]]);
        }
    }
...
<h2 style="font-size: 17px;">SECRET OPTION</h2>
</div>
<h3 style="font-size: 17px;"> Map </h3>
<label class="container">Turn On Map?
<input type="checkbox" id="myCheck">
<span class="checkmark"></span>
</label>
<h3 style="font-size: 17px;"> Music </h3>
<label class="container"> Music 1
<input type="checkbox" id="mus2">
<span class="checkmark"></span>
</label>
...
<label class="container"> Music 4
<input type="checkbox" id="mus4">
<span class="checkmark"></span>
</label>
<label class="container"> Music 5
<input type="checkbox" id="mus5">
<span class="checkmark"></span>
</label>
<label class="container"> Music 6
<input type="checkbox" id="mus6">
<span class="checkmark"></span>
</label>
...
<p>copied from the previous mod</p>
</div>
</div>
</div>
`
                                                                               ...
                                                                               var mus5 = false;
                                                                               var checkbox = document.querySelector("#mus5")
                                                                               ...
                                                                               var mus6 = false;
                                                                               var checkbox = document.querySelector("#mus6")
                                                                               ...
                                                                               var mus4 = false;
                                                                               var checkbox = document.querySelector("#mus4")
                                                                               ...
                                                                               var mus1 = false;
                                                                               var checkbox = document.querySelector("#mus1")
                                                                               ...
                                                                               var mus2 = false;
                                                                               var checkbox = document.querySelector("#mus2")
...
`))
                                                                               ...
                                                                               var ML = "https://cdn.discordapp.com/attachments/728226830414381056/731040282400915466/Two_Steps_From_Hell_-_Star_Sky_.mp3"
                                                                               var music = new Audio(ML);

                                                                               var rip = document.querySelector("#mus2")
                                                                               ...
                                                                               rip.addEventListener('change', function() {
                                                                                   if (this.checked) {
                                                                                       ...
                                                                                       document.getElementById("mus4").checked = false;
                                                                                       document.getElementById("mus5").checked = false;
                                                                                   } else {
                                                                                       music.pause();
                                                                                   }
                                                                               })

                                                                               var FB = "https://cdn.discordapp.com/attachments/728226830414381056/731039248915890247/Nightcore_-_12345SEX_Lyrics_-_UPSAHL.mp3"
                                                                               ...
                                                                               cree.addEventListener('change', function() {
                                                                                   if (this.checked) {
                                                                                       ...
                                                                                       music4.pause();
                                                                                       music5.pause();
                                                                                       document.getElementById("mus2").checked = false;
                                                                                       document.getElementById("mus1").checked = false;
                                                                                       document.getElementById("mus4").checked = false;
                                                                                       document.getElementById("mus5").checked = false;
                                                                                   } else {
                                                                               ...
                                                                               var IL = "https://cdn.discordapp.com/attachments/728226830414381056/731040137210888232/Alan_Walker_-_Unity_Extended_Version_by_Albert_Vishi.mp3"
                                                                               ...
                                                                               var AD = "https://ia800106.us.archive.org/4/items/LegendsNeverDieft.AgainstTheCurrentOFFICIALAUDIOWorlds2017LeagueOfLegends8/Legends%20Never%20Die%20%28ft.%20Against%20The%20Current%29%20%5BOFFICIAL%20AUDIO%5D%20-%20Worlds%202017%20-%20League%20of%20Legends_8.mp3"
                                                                               var music4 = new Audio(AD);

                                                                               var mus4 = document.querySelector("#mus4")

                                                                               mus4.addEventListener('change', function() {
                                                                                   if (this.checked) {
                                                                                       music4.play();
                                                                                       mine.pause();
                                                                                       music.pause();
                                                                               ...
                                                                               var FK = "https://ia803004.us.archive.org/0/items/GASGASGAS_201904/GAS%20GAS%20GAS.mp3"
                                                                               var music5 = new Audio(FK);

                                                                               var mus5 = document.querySelector("#mus5")

                                                                               mus5.addEventListener('change', function() {
                                                                                   if (this.checked) {
                                                                                       music5.play();
                                                                                       mus4.pause();
                                                                                       mine.pause();
                                                                               ...
                                                                               var AD = "https://ia800701.us.archive.org/34/items/InitialDDejaVu_201811/Initial%20D-Deja%20Vu.mp3"
                                                                               var music6 = new Audio(AD);

                                                                               var mus6 = document.querySelector("#mus6")

                                                                               mus6.addEventListener('change', function() {
                                                                                   if (this.checked) {
                                                                                       music6.play();
                                                                                       mine.pause();
                                                                                       music.pause();
...
document.title = "bot";
document.getElementById("gameName").innerText="Project  XD";
document.getElementById("gameName").style.color = "white";
document.getElementById("gameName").style.textShadow = "white 2px 2px 10px, white -2px -2px 10px";
setInterval( () => {
    if (BM == true) {
        doNewSend(["ch", ["lel"]]);
        setTimeout( () => {
            doNewSend(["ch", ["IM STRONG BOT"]]);
        }, 550)
        setTimeout( () => {
            doNewSend(["ch", ["Becc im Proo"]]);
        }, 1100)
        setTimeout( () => {
            doNewSend(["ch", ["YES YES YES"]]);
        }, 1550)
        setTimeout( () => {
            doNewSend(["ch", ["EZ EZ EZ EZZ"]]);
        }, 2100)
        setTimeout( () => {
            doNewSend(["ch", ["Stupid"]]);
        }, 2650)
        setTimeout( () => {
            doNewSend(["ch", ["win! win! win!"]]);
        }, 3200)
        setTimeout( () => {
            doNewSend(["ch", ["bec im winner "]]);
        }, 3750)
        setTimeout( () => {
            doNewSend(["ch", ["HAH! HAH! HAH!"]]);
        }, 4300)
    }
}, 4850)
setInterval( () => {
    if (MeleeBot == true) {
        doNewSend(["ch", ["MELEE MELEE MELEE!"]]);
        setTimeout( () => {
            doNewSend(["ch", ["IM STRONG MELEE"]]);
        }, 550)
        setTimeout( () => {
            doNewSend(["ch", ["Melee Bot All Times Win"]]);
        }, 1100)
        setTimeout( () => {
            doNewSend(["ch", ["YES YES YES"]]);
        }, 1550)
        setTimeout( () => {
            doNewSend(["ch", ["LOL LOL LOL"]]);
        }, 2100)
        setTimeout( () => {
            doNewSend(["ch", ["Stop Pls"]]);
        }, 2650)
        setTimeout( () => {
            doNewSend(["ch", ["win! win! win!"]]);
        }, 3200)
...
, function(e, t, n) {
    ...
    Ie.style.fontSize = "21px";
    Ie.style.fontFamily = "Verdana";
    ...
    var chatHistory = ["", ""], turretlock = 0, aimer = false, autb = false, autby = false, musketLock = 0, wh = 0, ah = 0, sh = 0, dh = 0, cSp = false, spin = false, canspin = 0, botMode = false, atplcr = false, commandPrefix = "/", showCommand = false, ignoreList = [], commands = [], camX = 0, camY = 0, lol, HT = 0, TY = 0, TX = 0, instaID = 0, atpcr = false, thtC = 0, camDir, dn = false, HIT = 0, camID, TA, HTE = false, tH = 0, nPoint, nEyT = 0, Mil = 0, nEyY, nEyX, AB = false, freeCam = false, clickerID, hitterID, primaryReload = [], secondaryReload = [], turretReload = [], chatHistoryDisplay = document.createElement('div')
    var invisspike = false, invistrap = false, invisspawn = false, invistele = false, quadtrap = false, quadspawn = false, invismill = false, quadtele = false, anbul = false, ABN = false;
    var em = 0;
    var commandPrefix = "-";
    ...
    var hT = {Shift:0, z:40, c:6, b:7, i:22, k:6};
    var dH = 0;
    ...
    window.addEventListener("keydown", s.checkTrusted((function(e) {
        ...
        r.send("7", 0)) : null != R.weapons[t - 49] ? (Sn(R.weapons[t - 49], !0),oW = R.weapons[t - 49]) : null != R.items[t - 49 - R.weapons.length] ? Sn(R.items[t - 49 - R.weapons.length]) : 81 == t ? Sn(R.items[0]) : 82 == t ? xn() : mn[t] ? bn() : 32 == t && (O = 1,
        vn({})),
    ...
    function xn() {
        ...
        r.send("2", nEA);
        Jt(0, 1);
        if(R.weapons[0] == 4 && (nEy[5] != 6 && nEy[5] != 22) && turretReload[R.sid] == 1){
            Hg(7, 18);
        }else if(nEy[5] != 11){
            Hg(7, 18);
        }
    ...
    function Si(e, t) {
        ...
        e == nEy[0]&&fgd(nEy, R)<l.weapons[oW].range+30&&t<l.weapons[oW].dmg*(nEy[9]==6?0.75:1)&&
        (iI++,r.send(2, nEA),
                        AA++,
                        r.send("2", nEA);
                        Jt(0, 1),
        ...
        if(d > 0){
            ...
            if(_.skinIndex == 7){
                if(_.tailIndex == 13){
                    if(d == -2){
                        _.lastBull = tC;
                        R == _ && (setTimeout(()=>{Sn(R.items[0]), r.send("c", 1),r.send("c", 0), Sn(oW, 1)}, 90), FT = 0)
                        return;
                    }
                }else{
                    if(d == -5){
            ...
            if(R == _){
                if(d <= -45 && dNG){
                    ...
                    /*if(R.skinIndex==11&&primaryReload[R.sid]==1&&nEy.length&&primaryReload[nEy[0]]==1&&nEy[9]==7&&fgd(nEy,R)<l.weapons[oW].range+30){
                        iI++;
                        AA++;
                        r.send("2", nEA);
                        Jt(0, 1);
    ...
    function Ti(e) {
        ...
        if(!iI && Qe.style.display == "none"){
            if(R.clownCounter > 0 && (tC - R.lastBull) % 9 == 0 || (R.lastBull && FT > 1)){
                ...
                }/*else if(!dH&&primaryReload[R.sid]==1&&!O&&l.weapons[oW].dmg>=40&&l.weapon[nEy[5]].dmg>=40&&fgd(nEy,R)<l.weapons[oW].range+30){
                    Hg(11, 21);
                }*/else{
                    if(dH){
                        Hg(dH, 19);
    ...
    function Pi() {
        var e = Date.now() - Ai;
        window.pingTime = e,
        Ie.innerText = "k spree Ping k: " + e + " ms"
    }
    function Bi() {
        Ai = Date.now(),
        r.send("pp")
...
if ((_ = W[a] || Y[a - W.length]).visible/* && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)*/) {
                    ...
                    window.items = R.items;
                                ...
                                (be.textAlign = "center",//hp number
                                 ...
                                 be.lineWidth = 6,
                                 be.strokeText(`\n${_.health}/${_.maxHealth}`,_.x - f,_.y - d + _.scale + o.nameY+(34)),
                                 be.fillText(`\n${_.health}/${_.maxHealth}`,_.x - f,_.y - d + _.scale + o.nameY+(34))
                                )
                    ...
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - 51 - o.healthBarPad, _.y - d + _.scale + o.nameY - 13, 2 * 25 + 2 * o.healthBarPad, 17, 10),
                    be.fill(),
                    be.fillStyle = primaryReload[_.sid] == 1 ? "#8ecc51" : "#cc5151",
                      be.roundRect(_.x - f - 51, _.y - d + _.scale + o.nameY - 13 + o.healthBarPad, 2 * 25 * (_.pr<primaryReload[_.sid]?_.pr+(primaryReload[_.sid]-_.pr)*Math.min(1,_.dt/111):primaryReload[_.sid]), 17 - 2 * o.healthBarPad, 10),
                    be.fill()),
                    (o.reloadBarWidth,
                    be.fillStyle = rt,
                    be.roundRect(_.x - f + 2 - o.healthBarPad, _.y - d + _.scale + o.nameY - 13, 2 * 24.5 + 2 * o.healthBarPad, 17, 10),
                    be.fill(),
                    be.fillStyle = secondaryReload[_.sid] == 1 ? "#8ecc51" : "#cc5151",
                    be.roundRect(_.x - f + 2, _.y - d + _.scale + o.nameY - 13 + o.healthBarPad, 2 * 24.5 * (_.sr<secondaryReload[_.sid]?_.sr+(secondaryReload[_.sid]-_.sr)*Math.min(1,_.dt/111):secondaryReload[_.sid]), 17 - 2 * o.healthBarPad, 10),
                                be.fill()),

                    (o.healthBarWidth,
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - 52 - o.healthBarPad, _.y - d + _.scale + o.nameY-28, 3.4 * 30 + 2 * o.healthBarPad, 17, 10),
                    be.fill(),
                    be.fillStyle = turretReload[_.sid] == 1 ? "#8ecc51" : "#cc5151",
                    be.roundRect(_.x - f - 52, _.y - d + _.scale + o.nameY-28 + o.healthBarPad, 3.4 * 30.5 * (_.tr+(turretReload[_.sid]-_.tr)*Math.min(1,_.dt/111)), 17 - 2 * o.healthBarPad, 10),
                    be.fill()))
                }
