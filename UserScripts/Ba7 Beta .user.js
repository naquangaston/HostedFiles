...
, function(e, t, n) {
    ...
    var at = document.getElementById("featuredYoutube")
      , ot = [{
        name: "Beastmode Revival",
        link: "https://www.youtube.com/channel/UCq1ed_Uh0AYUxD_y74z7xtg"
    }, {
        name: "Beastmode Revival",
        link: "https://www.youtube.com/channel/UCq1ed_Uh0AYUxD_y74z7xtg"
    }, {
        ...
        name: "Wolf Gaming Gaston",
        link: "https://www.youtube.com/channel/UCOA8lE9-0XnEIdHqjfQUz1A"
    }, {
        name: "Wolf Gaming Gaston",
        link: "https://www.youtube.com/channel/UCOA8lE9-0XnEIdHqjfQUz1A"
    }, {
    ...
    function cH(){
           if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Suck the Dick and Balls baby,");
                   }else{
                       return;
                   }
               }, 31000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("I beat the Pussy out the park");
                   }else{
                       return;
                   }
               }, 46000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("I keep a blower for the lawn,");
                   }else{
                       return;
                   }
               }, 63000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Treat the Pussy like Smokey,");
                   }else{
                       return;
                   }
               }, 111000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("I Fucked the Bitches edges off,");
                   }else{
                       return;
                   }
               }, 117000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("fighting you is a Fuckin joke");
                   }else{
                       return;
                   }
               }, 192000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("what the Fuck is that insta");
                   }else{
                       return;
                   }
               }, 205000);
       ...
       function cH2(){
           if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("That's how you already know");
                   }else{
                       return;
                   }
               }, 16000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("Rape you 'till ya Booty melt");
                   }else{
                       return;
                   }
               }, 22000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("yes I like to send 'em Nudes");
                   }else{
                       return;
                   }
               }, 38000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("he like to Fuck until we loose");
                   }else{
                       return;
                   }
               }, 40000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("that's Dildo practice with the Lube");
                   }else{
                       return;
                   }
               }, 43000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("when we pull up send the Nudes");
                   }else{
                       return;
                   }
               }, 46000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("y'know I might suck the crew");
                   }else{
                       return;
                   }
               }, 110000);
               ...
               setTimeout(()=>{
                   if(cSp && document.activeElement.id.toLowerCase() !== 'chatbox'){
                       sn("I Fucked with Semen I produced");
                   }else{
                       return;
                   }
               }, 118000);
    ...
    function gi(e) {
        ...
        if (e) {
            ...
            for (t = 0; t < e.length; )
                ...
                _.d2 = _.dir,
                _.health = e[t + 5],
                Z.aiTypes[e[t + 1]].name || (_.name = "My existence is meaningless."),
                _.forcePos = !0,
                _.sid = e[t],
                _.visible = !0),
                t += 7
...
document.getElementById('menu').innerHTML =
    `<h3 style="font-size: 20px;" class = "indent">^%*& Ba7 Mod &*%^</h3>`
...
<body>
<br>
<h2 style="font-size: 17px;">Aim+Chat+Building HP</h2>
<label class = "indent">Circle Hit<input type = "checkbox" id = "hit"><br>
<label class = "indent">Magical Ae86 Aim<input type = "checkbox" id = "ae86aim"><br>
<label class = "indent">Useless<input type = "checkbox" id = "spin"><br>
<label class = "indent">Special Ed Chat<input type = "checkbox" id = "noob"><br>
<label class = "indent">Build HP<input type = "checkbox" id = "bhp"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">Automation Stuffs</h2>
<label class = "indent">AutoPlace<input type = "checkbox" id = "autoplacer"><br>
<label class = "indent">ReplaceBuilds<input type = "checkbox" id = "autoreplacer"><br>
<label class = "indent">AutoBreak<input type = "checkbox" id = "autobreaker"><br>
<label class = "indent">BuyAll<input type = "checkbox" id = "buyer"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">Invis+Quad</h2>
<label class = "indent">Invis Spiek<input type = "checkbox" id = "invis-spike"><br>
<label class = "indent">Invis Trippy<input type = "checkbox" id = "invis-trap"><br>
<label class = "indent">Invis Useless<input type = "checkbox" id = "invis-spawn"><br>
<label class = "indent">Invis Useless more<input type = "checkbox" id = "invis-tele"><br>
<label class = "indent">Invis Pointless<input type = "checkbox" id = "invis-mill"><br>
<label class = "indent">Quad Trippy<input type = "checkbox" id = "quad-trap"><br>
<label class = "indent">Quad Spawnpad<input type = "checkbox" id = "quad-spawn"><br>
<label class = "indent">Quad Teley<input type = "checkbox" id = "quad-tele"><br>
<h2 style="font-size: 15px;">_____________________________________________</h2>
<h2 style="font-size: 17px;">Bot Bullshit</h2>
...
<h2 style="font-size: 17px;">Song Toggles</h2>
