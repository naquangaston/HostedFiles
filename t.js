...
async function getRemoteFile(file, url, meta) {
    if (Object.keys(downloadings).length > 19) { setTimeout(e => { getRemoteFile(file, url, meta) }, 100); return }
    //console.count()
...
//console.log('restarting');ptr.forEach(removeDir)
...
var maxTs = 5, msend = 0
    ; (async () => {
        ...
        await wait_();
        await done_();
        await get(['inflation','~hose','~wickerbeast','~hobkin','~nargacuga','~rexouium','~nardoragon', '~dreamertooth','~penetration','~okuri','~ishiru','~dragon','~muzz','~buttplug','~submissive','~3d_(artwork)','~renamon','~bunny','~bent_over','~carrot','~improvised_sex_toy','~blender_(software)','~pokemon','~bdsm','~webm,','~avali','~rubber_suit','~forced','~water_inflation','~egg','~bound','~harness','~animated','~bondage','~belly','~facesitting','~rimming','~anal','~force_feeding','~muzzle_(object)'], dns)
        await get(['expansion','~hose','~wickerbeast','~hobkin','~nargacuga','~rexouium', '~nardoragon','~dreamertooth','~penetration','~okuri','~ishiru','~dragon','~muzz','~buttplug','~submissive','~3d_(artwork)','~renamon','~bunny','~bent_over','~carrot','~improvised_sex_toy','~blender_(software)','~pokemon','~bdsm','~webm,','~avali','~rubber_suit','~forced','~water_inflation','~egg','~bound','~harness','~animated','~bondage','~belly','~facesitting','~rimming','~anal','~force_feeding','~muzzle_(object)'], dns)
        await wait_();
        await done_()
        await get(['~wickerbeast','~hobkin','~nargacuga','~rexouium','~nardoragon','webm'],dns);
        await get(['~wickerbeast','~hobkin','~nargacuga','~rexouium'],dns);
        await wait_();
        /*list = [
