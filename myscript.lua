print('Starting up')--loadstring(game:HttpGet("https://raw.githubusercontent.com/naquangaston/HostedFiles/main/myscript.lua"))()
	...
	Humanoid:GetPropertyChangedSignal("Health"):Connect(function()
		...
		pcall(function()
			if Humanoid.Health < OldHealth then
				...
				if increaseByPercentage(game.Players.LocalPlayer.leaderstats.Level.value,20) < enemy.lvl then warn(enemy.player.name.." Is to strong self");return end
